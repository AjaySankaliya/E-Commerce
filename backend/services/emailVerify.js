...
const verifyEmail = async (token, email) => {
  const frontendUrl = (process.env.FRONTEND_URL || "https://e-commerce-hazel-phi.vercel.app").trim();
      ...
      <div style="background-color: #ffffff; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
        ...
        <div style="color: #4a4a4a; line-height: 1.6; font-size: 16px;">
          ...
          <div style="text-align: center; margin: 35px 0;">
            <a href="${verificationLink}" style="background-color: #000000; color: #ffffff; padding: 14px 32px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; display: inline-block; transition: background-color 0.3s ease;">Verify Email Address</a>
          </div>
          ...
          <p style="word-break: break-all; margin-bottom: 30px;"><a href="${verificationLink}" style="color: #0066cc; text-decoration: underline; font-size: 14px;">${verificationLink}</a></p>
